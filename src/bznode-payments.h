...
//! minimum peer version that can receive and send bznode payment messages,
//  vote for bznode and be elected as a payment winner
// V1 - Last protocol version before update
// V2 - Newest protocol version
static const int MIN_BZNODE_PAYMENT_PROTO_VERSION_1 = 99023;
static const int MIN_BZNODE_PAYMENT_PROTO_VERSION_2 = 99024;
...
void FillBlockPayments(CMutableTransaction& txNew, int nBlockHeight, CAmount blockReward, CTxOut& txoutBznodeRet, std::vector<CTxOut>& voutSuperblockRet);
